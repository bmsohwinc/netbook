...
async def myloop(request):
    """
    Simple loop tester
    """
    print(">>> Starting the myloop sleep...")
    await asyncio.sleep(10)
    print("<<< Woke up from 10 seconds sleep. Sending response now...")
    return PlainTextResponse("### I am a myloop response ###")
